  ...
  <div className={styles['pre-content']}>
    <div className={withoutBottomLine ? `${styles.inner} ${styles['inner--without-bottom-line']}` : styles.inner}>
      <div className={styles.links}>
        <Link to="/blogs/1">Башкы бет</Link>
        <span className={styles.devider} />
        <a href="https://kentcdodds.com/links/" target="_blank" rel="noopener noreferrer">IT коммюнити</a>
      </div>
      <div className={styles.actions}>
        ...
        <button className="btn btn--smallest">Жазылуу</button>
      </div>
    </div>
  </div>
);
